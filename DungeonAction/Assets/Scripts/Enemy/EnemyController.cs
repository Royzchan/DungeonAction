...
public class EnemyController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (_collider == null) Debug.LogError("Colliderが登録されていません。");
    ...
    protected virtual void Start()
    {
        ...
        if (_hpSlider == null)
        {
            Debug.LogError("HPBarSliderが登録されていません。");
        }
        else
        {
    ...
    public virtual void Die()
    {
        ...
        {
            Debug.Log("GameManagergが登録されていません。");
        }
        ...
        {
            Debug.LogError("SkillTreeControllerが登録されていません。");
        }
    }
